...
/*   Updated: 2021/05/06 19:12:30 by lelsweyr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* minishell.c */
int		zreak_n_cycle(t_all *all, char buf[1000], int len);
void	z_cycle(t_all *all, char buf[1000], t_p *p, t_dlist *hist);
void	z_cycle_begin(t_all *all);
void	z_cycle(t_all *all);
